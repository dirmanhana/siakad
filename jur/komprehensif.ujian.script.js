...
function showDosen(ProdiID, frm, NamaDosen, indexKompre, NamaDiv) { 
  xmlHttp=GetXmlHttpObject()
  if (xmlHttp == null) {
    alert ("Browser does not support HTTP Request")
    return
  }
  var url = "../jur/caridosenkompre.php"
  url = url + "?ProdiID=" + ProdiID;
  url = url + "&frm=" + frm;
  url = url + "&Nama=" + NamaDosen;
  url = url + "&indexKompre=" + indexKompre;
  url = url + "&div=" + NamaDiv;
  url = url + "&img=img";
...
function showRuang(ProdiID, frm, RuangID, indexKompre, NamaDiv) { 
  xmlHttp=GetXmlHttpObject()
  if (xmlHttp == null) {
    alert ("Browser does not support HTTP Request")
    return
  }
  var url = "../jur/cariruangkompre.php"
  url = url + "?ProdiID=" + ProdiID;
  url = url + "&frm=" + frm;
  url = url + "&indexKompre=" + indexKompre;
