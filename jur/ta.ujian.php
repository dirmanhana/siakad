...
HeaderSisfoKampus("Setup Ujian Skripsi/TA", 1);
...
// *** Main ***
TampilkanJudul("Setup Ujian Skripsi/TA");
...
function TampilkanHeaderTA($ta) {
  ...
  <tr><td class=inp>Tgl Ujian Akhir:</td>
...
function Simpan() {
  ...
  $s = "update ta
    set Penguji = '$DosenID', TglUjian = '$TglUjian',
