...
// *** Main ***
TampilkanJudul("Cetak Kartu Ujian Akhir Semester Mahasiswa");
...
function TampilkanHeader() {
  ...
  <tr><td class=inp>Angkatan Mhsw:</td>
      ...
      <input type=submit name='btnCetak' value='Cetak Kartu UAS' /><br />
      *) Kosongkan jika ingin mencetak 1 angkatan
      </td>
      </tr>
  <tr><td colspan=4 align=center><input type=button name='Cetak' value='Cetak Daftar Yang Tidak Bisa UAS' onClick="CetakDaftarTakBisaUjian()">
	  </td>
	  </tr>
  </form>
  </table>
