...
*/  
  ...
  while ($w = _fetch_array($r)) {
	...
	echo "<tr>
      ...
      <td $c>$w[MKKode] <a href='#' onClick=\"javascript:FormNilaiEksport($w[JadwalID])\" title='Eksport Form Isi Nilai'><img src='img/excel.gif' width=16 /></a></td>
      ...
      <td $c align=center>
          <input type=button name='Isi' value='&raquo; Nilai' onClick=\"location='?mnux=$_SESSION[mnux]&gos=$gos2&_nilaiJadwalID=$w[JadwalID]'\" />          
      </td>
  ...
  function FormNilaiEksport(id) {
      lnk = "$_SESSION[mnux].FormNilaiEksport.php?JadwalID="+id;
      win2 = window.open(lnk, "", "width=600, height=400, scrollbars, status");
      if (win2.opener == null) childWindow.opener = self;
  }
  //-->
...
SCR;
  ...
  while ($w = _fetch_array($r)) {
    ...
    echo "<tr>
      ...
      <td class=ul $wd>$Presensi<input type=hidden name='Presensi_$n' value='$Presensi' size=3 maxlength=4 tabindex=$_pr readonly=true /></td>
      <td class=ul $wd><input type=text name='Tugas1_$n' value='$w[Tugas1]' size=3 maxlength=5 tabindex=$_t1 $ro /></td>
      <td class=ul $wd><input type=text name='Tugas2_$n' value='$w[Tugas2]' size=3 maxlength=5 tabindex=$_t2 $ro /></td>
      <td class=ul $wd><input type=text name='Tugas3_$n' value='$w[Tugas3]' size=3 maxlength=5 tabindex=$_t3 $ro /></td>
      <td class=ul $wd><input type=text name='Tugas4_$n' value='$w[Tugas4]' size=3 maxlength=5 tabindex=$_t4 $ro /></td>
      <td class=ul $wd><input type=text name='Tugas5_$n' value='$w[Tugas5]' size=3 maxlength=5 tabindex=$_t5 $ro /></td>
      <td class=ul $wd><input type=text name='UTS_$n' value='$w[UTS]' size=3 maxlength=5 tabindex=$_ut $ro /></td>
      <td class=ul $wd><input type=text name='UAS_$n' value='$w[UAS]' size=3 maxlength=5 tabindex=$_ua $ro /></td>
