...
HeaderSisfoKampus("Edit Ujian Komprehensif", 1);
...
function TampilkanHeaderKompre($md,$kom) {
  ...
  $NamaPenguji = GetaField('dosen', "KodeID='".KodeID."' and Login", $kom['Penguji'], 'Nama');
	...
	if ($md == 0){
		$jdl = "Edit Nilai Ujian Komprehensif";
		...
		$jdl = "Input Nilai Ujian Komprehensif";
		$TahunAkd = '';
		$Mhsw = '';
		$MhswID = '';
		$PA = '';
  ...
  <tr><td class=inp colspan=2>
	...
	<tr>
		...
		<th class=ttl align=center>Mata Kuliah Ujian Komprehensif</th>
