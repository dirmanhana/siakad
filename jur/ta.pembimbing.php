...
function TampilkanHeader() {
  ...
  <tr><td class=inp width=100>NIM:</td>
...
ESD;
  ...
  <input type=hidden name='TAID' value='$TAID' />
    <tr><td class=inp width=100>&raquo; Tambah<br />Pembimbing:</td>
      ...
      <input type=text name='Dosen' value='$NamaPenguji' size=30 maxlength=50 onKeyUp="javascript:CariDosen('$mhsw[ProdiID]', 'frmTA')" />
      &raquo;
      <a href='#'
...
function fnTambah($TAID) {
  ...
  $cek1 = GetFields('tadosen', "TAID='$TAID' and DosenID",$DosenID,'*');
  if(!empty($cek)){
    die(ErrorMsg('Error', 
