...
function KonfirmasiProsesNIM($pmbid, $pmb) {
  ...
  $statusawalid2_info = ($pmb['StatusAwalID2'] == 'Y')? 'Mahasiswa Transfer' : 'Non Transfer';
  CheckFormScript('Tahun_Akd');
  echo Konfirmasi('Konfirmasi Proses NIM',
    ...
    <tr><td class=inp>Status:</td>
        <td class=ul1>$statusawalid2_info
        </td></tr>
...
function ProsesNIM($pmbid, $pmb) {
  ...
  $s = "insert into mhsw
    ...
    Nama, StatusAwalID, StatusAwalID2, StatusMhswID,
    ...
    '$pmb[Nama]', '$pmb[StatusAwalID]', '$pmb[StatusAwalID2]', '$StatusMhswID',
