...
$ket_bayar = GetFields("bayarmhsw", "BayarMhswID", $id, "Keterangan,Tanggal");
...
$content .= '
    ...
    <table class="tidakgaris">
        <tr>
            ...
            <table class="garis"><tr><td width="200" height="40" class="keterangan">' . $ket_bayar["Keterangan"] . '</td></tr></table>
            </td>
            
            <td class="tengah">' . strtoupper($identitas['Kota']) . ', ' . strtoupper(GetDateInWords($ket_bayar["Tanggal"])) . '<br><br><br><br><br>(.......................................)</td>
        </tr>
