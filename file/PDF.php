 ...
 *
 * $Horde: framework/File_PDF/PDF.php,v 1.55 2007/09/14 10:20:24 jan Exp $
 *
...
class File_PDF {
            ...
            if ($l > $wmax) {
                ...
                if ($sep == -1) {
                    ...
                    if ($align == 'J') {
                        ...
                        $this->_out(sprintf('%.3' . FILE_PDF_FLOAT . ' Tw', $this->_word_spacing * $this->_scale));
                    }
                   ...
                   $link = '')
    {
        ...
        $this->_out(sprintf('q %.2' . FILE_PDF_FLOAT . ' 0 0 %.2' . FILE_PDF_FLOAT . ' %.2' . FILE_PDF_FLOAT . ' %.2' . FILE_PDF_FLOAT . ' cm /I%d Do Q', $width, $height, $x, $this->hPt - ($y + $height), $info['i']));
