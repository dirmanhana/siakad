...
function frmBank() {
  ...
  <tr><td class=inp>Autodebet</td><td class=ul><input type=checkbox name='Autodebet' value='Y' $ad $disabled></td></tr>
  <tr><td class=inp>Nama Bank</td><td class=ul><input type=text name='NamaBank' value='$datamhsw[NamaBank]' size=40 maxlength=50 $disabled></td></tr>
  <tr><td class=inp>Nomer Rekening</td><td class=ul><input type=text name='NomerRekening' value='$datamhsw[NomerRekening]' size=40 maxlength=50 $disabled></td></tr>
  <tr><td colspan=2 class=ul align=center>$btnSimpan
    $btnReset</td></tr>
  </form></table></p>";
}
