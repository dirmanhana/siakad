...
function PTSav() {
  ...
  if ($md == 0) {
    ...
    if (!empty($ada)) echo ErrorMsg("Data tidak dapat disimpan",
      "Data tidak dapat disimpan karena kode perguruan tinggi <b>$PerguruanTinggiID</b> telah digunakan oleh
      perguruan tinggi <b>$ada[Nama]</b>.<br>
      Gunakan kode perguruan tinggi yg lain.");
    else {
...
$asalsekolah = GetSetVar("NamaPerguruanTinggi");
