...
{	$NomerSurat = GetaField('pmb', "PMBID='$pmb[PMBID]' and KodeID", KodeID, 'NomerSurat');
	...
	$PejabatAkademik = GetFields('pejabat', "KodeJabatan='KABAA' and KodeID", KodeID, "Nama, Jabatan");
	$db_data[] = array('Isi'=>"<b>$PejabatAkademik[Nama]</b>");
	$db_data[] = array('Isi'=> "$PejabatAkademik[Jabatan]");
