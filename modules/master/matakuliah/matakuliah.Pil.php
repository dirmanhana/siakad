...
function DefPil() {
  ...
  if (!empty($_SESSION['prodi'])) {
    TampilkanMenuPilihanWajib();
    TampilkanPilihanWajib();
  }
}

function TampilkanMenuPilihanWajib() {
  global $mnux, $pref, $token;
  echo "<p><a href='?mnux=$mnux&$pref=Pil&sub=PilEdt&md=1'>Tambah Jenis Pilihan Wajib</a> |
  <a href='?mnux=$mnux&$pref=Pil&sub=CetakPilihanWajib'>Cetak</a></p>";
}
function TampilkanPilihanWajib() {
  ...
  while ($w = _fetch_array($r)) {
    ...
    echo "<tr><td class=ul><a href='?mnux=$mnux&$pref=Pil&sub=PilEdt&md=0&JenisPilihanID=$w[JenisPilihanID]'><img src='img/edit.png'>
      $w[Singkatan]</a></td>
      <td $c>$w[Nama]</td>
      <td $c><img src='img/$w[TA].gif'></td>
