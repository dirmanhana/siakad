...
function TampilkanMenuKons() {
  global $mnux, $pref, $token;
  echo "<p><a href='?mnux=$mnux&$pref=$_SESSION[$pref]&sub=KonsEdt&md=1'>Tambah Konsentrasi</a> |
  <a href='?mnux=$mnux&$pref=$_SESSION[$pref]&sub=CetakKons'>Cetak</a></p>";
}
function TampilkanKons() {
  ...
  while ($w = _fetch_array($r)) {
    ...
    echo "<tr><td $c>$n</td>
    <td $c nowrap><a href='?mnux=$mnux&$pref=$_SESSION[$pref]&sub=KonsEdt&konsid=$w[KonsentrasiID]&md=0'><img src='img/edit.png' border=0>
...
function KonsEdt() {
  ...
  <tr><td class=inp1>Kode Konsentrasi</td><td class=ul><input type=text name='KonsentrasiKode' value='$w[KonsentrasiKode]' size=20 maxlength=20></td></tr>
