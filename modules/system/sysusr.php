...
function DftrUsr() {
  ...
  $optlvl = GetOption2('level', "concat(LevelID, '. ', Nama)", 'LevelID', $_SESSION['LevelID'], "Accounting = 'N'", 'LevelID');
  $cs = 6;
  echo "<p><table class=box cellspacing=1 cellpadding=4>
    <form action='?' method=POST>
    <input type=hidden name='mnux' value='sysusr'>
    <tr><td class=ul>Institusi</td><td class=ul><select name='KodeID' onChange='this.form.submit()'>$optkd</select></td></tr>
