...
function TampilkanHeaderProses() {
  ...
  <form action='_proses_hitung_sks_mhsw.php' method=POST>
...
function ProsesHitung() {
  ...
  // IFRAME
  echo "<p><IFRAME src='_proses_hitung_sks_mhsw.go.php?gos=hitungsks' frameborder=0 height=400 width=300>
  </IFRAME></p>";
}
...
// *** Main ***
TampilkanJudul("Proses Hitung SKS Mahasiswa");
