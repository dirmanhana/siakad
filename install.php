...
include_once "./library/dwo.lib.php";

if (file_exists("./config/connectdb.php")) {
    include_once "./library/db.mysql.php";
...
<body class="small cwPageBg" topmargin="0" leftmargin="0" marginheight="0" marginwidth="0">
   <br><br><br>
    ...
    <table border=0 cellspacing=0 cellpadding=0 width=80% align=center>
        <tr>
            <td background="install/include/install/images/topInnerShadow.gif" align=left><img src="install/include/install/images/topInnerShadow.gif" ></td>
        </tr>
    </table>
                ...
                <table border=0 cellspacing=0 cellpadding=0 width=97%>
                    <tr>
                        ...
                        <!-- Right side tabs -->
                            <div class=isi>
                                <?php
                                    if (file_exists("./install/" . $_REQUEST['instl'] . ".php")) {
                                        include "./install/" . $_REQUEST['instl'] .".php";
                                    }
                                ?>
                            </div>
			</td>
    ...
    <table border=0 cellspacing=0 cellpadding=0 width=80% align=center>
        <tr>
            <td background="install/include/install/images/bottomGradient.gif"><img src="install/include/install/images/bottomGradient.gif"></td>
	</tr>
    </table>
	
    <table border=0 cellspacing=0 cellpadding=0 width=80% align=center>
	<tr>
	    <td align=center><img src="install/include/install/images/bottomShadow.jpg"></td>
	</tr>
    </table>
