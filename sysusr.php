...
// *** Main ***
TampilkanJudul('Administrasi User'.$_SESSION['_LevelID']);
...
function DftrUsr() {
  ...
  if (!empty($_SESSION['LevelID'])) {
    ...
    $a = "<p>
      <table class=box cellspacing=1 cellpadding=4 width=700>
    ...
    while ($w = _fetch_array($r)) {
      ...
      $a .= "<tr>
        ...
        <td $c><a href='?mnux=$_SESSION[mnux]&gos=UsrEdt&LevelID=$_SESSION[LevelID]&md=0&Lgn=$w[Login]'><img src='img/edit.png' border=0>
        $w[Login]</a></td>
        <td $c>$w[Nama]</td>
        <td $c>$w[ProdiID]&nbsp;</td>
