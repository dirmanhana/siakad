...
function TampilkanMenuModul() {
  echo "<p align=center><a href=\"?mnux=sysmod&token=DftrMdl\">Daftar Modul</a> |
...
function DftrMdl() {
  ...
  while ($w = mysql_fetch_array($r)) {
    ...
    echo "<tr>
      <td $c><a href=\"?mnux=$_SESSION[mnux]&token=ModEdt&md=0&mid=$w[MdlID]\"><img src='img/edit.png' border=0></a>
      $n</td>
      <td $c>$w[Nama]</td>
      <td $c>$w[LevelID]</td>
      <td $c>$w[Script]</td>
