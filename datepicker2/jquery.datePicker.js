...
//					$('.selectee', this.context).focus();
	...
	// localisable text
	$.dpText = {
		TEXT_PREV_YEAR		:	'Tahun Sebelumnya',
		TEXT_PREV_MONTH		:	'Bulan Sebelumnya',
		TEXT_NEXT_YEAR		:	'Tahun Selanjutnya',
		TEXT_NEXT_MONTH		:	'Bulan Selanjutnya',
		TEXT_CLOSE			:	'Tutup',
		TEXT_CHOOSE_DATE	:	'Pilih tanggal',
