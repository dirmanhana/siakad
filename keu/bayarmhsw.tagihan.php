...
$ambilNoCetakTagihan = GetaField('cetaktagihan', "KodeID='" . KodeID . "' and TahunID = '$TahunID' and MhswID", $MhswID, 'max(NoCetakTagihan)');
...
$content .= '        
    ...
    <table>
        ...
        <tr>
            ...
            <td></td>
            <td>Prodi : ' . $mhsw["ProdiID"] . ' Smt : ' . $smt . ' - ' . $smt_sesi . '</td>
        </tr>
        <tr>
...
$html2pdf->Output('Tagihan_' . $MhswID . '_' . $TahunID . '.pdf');
?>
